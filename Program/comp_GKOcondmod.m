function [relError, Mu, maxrelError, maxMu, max_gkomod] = comp_GKOcondmod (moddir, logfile, org_name, prot_cor)
...
[maxrelError, maxMu]=comp_condmod(repelem({max_gkomod}, length(condNames)), org_name, false, prot_cor);
