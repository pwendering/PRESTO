%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% function [ecModelBatch, changes] = modifyKcats(ecModelBatch,expVal,modifiedKcats,name)
%
...
%                    Kinetic parameters.
%   -changes:   Table  containing information on the changed kcats
%  
% Marius Arend      Last edited. 2021-10-31
