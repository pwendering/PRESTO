...
function model = otherChanges(model)
    ...
    % This has already been removed from the GEM in preprocessYeast.m
    % (2021-10-14)
...
%          if isempty(pos_rxn)
%              %these annotations have already been removed in the GEM 
%              %try to 
%              pos_rxn  = find(strcmpi(model.rxnNames,rxn_name));
...
%      end 
    ...
    % Remove protein P40009 (Golgi apyrase) from missanotated rxns This has already been removed from the GEM in preprocessYeast.m
    % (2021-10-14)
